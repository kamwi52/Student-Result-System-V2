...
class GradingScaleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::transaction(function () {
            ...
            $juniorScale = GradingScale::create([
                'name' => 'Junior Secondary (Formative)',
                'description' => 'Standard grading for Grades 8-9 based on percentages.'
            ]);
            ...
            $seniorScale = GradingScale::create([
                'name' => 'Senior Secondary (Exam)',
                'description' => 'Standard grading for Grades 10-12 based on a 1-9 numeric scale.'
            ]);
