        ...
        <div class="max-w-md mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.subjects.processImport') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        {{--
                         <div class="mt-4">
                              <x-input-label for="options" :value="__('Import Options')" />
                              <input type="text" id="options" name="options" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" />
                         </div>
                         --}}
