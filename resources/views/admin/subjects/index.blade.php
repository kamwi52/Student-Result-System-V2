<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <!-- This container holds both buttons -->
            <div>
                <!-- This is the new Import button -->
                <a href="{{ route('admin.subjects.import.show') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150 mr-2">
                    Import Subjects
                </a>

                <!-- This is your existing Create button -->
                                ...
                                @forelse ($subjects as $subject)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <form action="{{ route('admin.subjects.destroy', $subject) }}" method="POST" class="inline-block ml-4" onsubmit="return confirm('Are you sure?');">
                                                @csrf
                                                @method('DELETE')
