...
<head>
    ...
    <style>
        ...
        .header h2 { margin: 5px 0; font-size: 18px; font-weight: normal; color: #555; }
        ...
        .subject-header { background-color: #e2e2e2; font-weight: bold; }
        ...
        <tbody>
            @forelse ($reportData as $subjectName => $data)
                <tr class="summary">
                    ...
                    <td>
                        @if($data['final_grade'] >= 90)
                            Outstanding
                        @elseif($data['final_grade'] >= 80)
                            Excellent
                        @elseif($data['final_grade'] >= 70)
                            Very Good
                        @elseif($data['final_grade'] >= 60)
                            Good
                        {{-- THE FIX IS ON THIS LINE --}}
                        @elseif($data['final_grade'] >= 50) 
                            Satisfactory
                        @else
                            Needs Improvement
                        @endif
