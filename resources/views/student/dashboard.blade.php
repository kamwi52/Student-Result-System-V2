            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-start">
                        ...
                        {{-- === FIX: ADDED REPORT CARD BUTTON === --}}
                        <div>
                             <a href="{{ route('student.report') }}" target="_blank"
                        ...
                        @forelse($enrollments as $enrollment)
                            ...
                            <a href="{{ route('student.class.results', $class->id) }}" class="block p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-150 ease-in-out">
                                ...
                                <div class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                    {{-- Assuming a class section has one primary teacher --}}
                                    Teacher: {{ $class->teachers->first()->name ?? 'N/A' }} | 
